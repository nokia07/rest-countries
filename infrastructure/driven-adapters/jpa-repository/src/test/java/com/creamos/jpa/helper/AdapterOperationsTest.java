package com.creamos.jpa.helper;

import com.creamos.jpa.CountryDataRepository;
import com.creamos.jpa.CountryRepositoryAdapter;
...
class AdapterOperationsTest {
    ...
    void setUp() {
        ...
        adapter = new CountryRepositoryAdapter(repository, objectMapper);
    }
